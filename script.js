...
document.addEventListener('DOMContentLoaded', () => {
    ...
    async function initializeGame() {
        ...
        try {
            ...
            // If the server's version is newer, a reset has happened.
            ...
            console.error("Could not sync with server, using local data only.");
        }
